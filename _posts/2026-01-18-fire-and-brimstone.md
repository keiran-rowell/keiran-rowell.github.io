...
<div style="margin: 2rem 0; padding: 1.5rem; background: rgba(0,0,0,0.05); border-left: 4px solid #F1DD38; text-align: center; font-family: monospace;">
  CaSO<sub>4</sub>·2H<sub>2</sub>O(s) + CH<sub>3</sub>COO<sup>-</sup>(aq) + H<sup>+</sup>(aq) &rarr; CaCO<sub>3</sub>(s) + CO<sub>2</sub>(g) + 3H<sub>2</sub>O(l) + <span style="color: #F1DD38; font-weight: bold;">S<sup>0</sup>(s)</span>
</div>
