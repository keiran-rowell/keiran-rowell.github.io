...
These days, it is common to introduce students to benzene's structure through a smearing of two "resonance" structures. Due to a dogged adherence to Lewis bonding and "formal charges" as an pedagogical accounting tool for  building bonding lines up from atoms, two valid Lewis structures are arrived at with "resonance equilibrium arrow" introduced between them (though the reality being "1.5" bonds is generally acknowledge). So, how did we get to two so-called ""Kekulé"" structures of benzene if the early pioneers and experimental evidence evinced a complete symmetry in the nature of benzene?
