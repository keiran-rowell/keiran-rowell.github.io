...
The connection to colour and dyestuffs in the novel does not end there; the essay [*"Coloring Gravity's Rainbow"*](https://doi.org/10.16995/pn.374) applies a critical lens to these chromatic and chemical connections and charts how they shift throughout the book. The protagonist's very name ---Tryone--- has be interpreted to be linked with Tyrian purple, his colour depiction alters as the narrative shifts towards a totalising blazing white, and obssessive subjectation of nature to nomenclature and technology is linked explicitly organic chemistry colour industry terms. 
