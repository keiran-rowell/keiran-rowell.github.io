...
- Pauling may be responsible for popularising, and mispopularising, electron delocalisation concepts in language and rules palatable to the synthetic chemists of his day, but [Fritz Arndt is responsible](https://pubs.acs.org/doi/pdf/10.1021/ed036p336?ref=article_openPDF) for misleading double-headed arrow when expounding on the idea of a "[Zwischenstufe](https://doi.org/10.1002/cber.19300631108)" (intermediate state) in resonance structures.
