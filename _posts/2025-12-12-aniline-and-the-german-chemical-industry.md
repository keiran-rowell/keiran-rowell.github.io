...
The connection to colour and dyestuffs in the novel does not end there; the essay [*"Coloring Gravity's Rainbow"*](https://doi.org/10.16995/pn.374) applies a critical lens to these chromatic and chemical connections and charts how they shift throughout the book. The protagonist's very name ---Tryone--- has be interpreted to be linked with Tyrian purple, his colour depiction alters as the narrative shifts towards an annihilaiting white, and the obssessive subjectation of nature through nomenclature and technology is linked explicitly organic chemistry colour industry terms. 
...
- Resonance  --- a terrible misnomer, as with most chemical nomenclature, because molecular nuclei do *not* 'resonate' between two separate resonance structures ([as many of the original theorists well knew, though confusion rose rapidly due partly to sloppy exposition by Pauling in a campaign to expand the conceptual basis of structural chemistry.](https://www.jstor.org/stable/4027968)).  [misunderstanding of Kekule claiming "vibrating" he literally meant internal vibrational temporary distortions of a $$D_{6h}$$ symmetric ring, not oscillating between "resonance contributors" 
- Figure of benzene "resonance contributors" and the true delocalised dashed line ring version
-  First year chemistry undergrads are often subjected to these truly fictious "resonance contributors" with a misapplied notation of chemical equilibrium, due dogged adherence to Lewis structures and formal charge notation as a teaching tool.
- Pauling may be responsible for popularising, and mispopularising, electron delocalisation concepts in language and rules palatable to the synthetic chemists of his day, but [Fritz Arndt may be ultimately responsible](https://pubs.acs.org/doi/pdf/10.1021/ed036p336?ref=article_openPDF) taken as misleading double-headed arrow when expounding on the idea of a "[Zwischenstufe](https://doi.org/10.1002/cber.19300631108)" (intermediate state) in resonance structures. To Arndt's credit he never committed to an oscillating model, or timescale, and emphasised purely electronic orbital rearrangment in a pre-quantum mechnical explanation.
%% Make this a strong take, lay into the tension between a popularised theory that appeals but needs to then be *un*taught (or unlearned if you're from USYD marketing) versus very early correct intuition and rigirous theory with the facts, yet is inchoate so couldn't easily be conveyed.
- This wouldn't be the last, nor most harmful time, when Pauling's prestige, accumulation of credits, and teaching skills would [generate a best seller](https://openlibrary.org/books/OL4914696M/Vitamin_C_and_the_common_cold), [popularise a dubious concept](https://www.sciencehistory.org/stories/magazine/linus-paulings-vitamin-c-crusade/), that lead to [a lot of wasted money and time](https://theweek.com/articles/454161/how-vitamin-industrial-complex-swindled-america) [despite a bongo accompanied retort from an equally lionised scientist in his final days](https://youtu.be/HKTSaezB4p8?si=sXm1DxhbSutiJDPQ).  
- The Soviet opposition to resonance. The term mesomerism occasionally making an appearance instead.  
A vocal minority of Soviet scientists [viewed the resonance concept as fictitious mathematical idealisation that was antithetical to dialectal materialism](https://www.jstor.org/stable/227752), so the state adopted a terminological slight of hand to avoid referring to resonance or using 'resonance structures' as a teaching aid. "Mesmorism" was considered more palatable to realist philsophy than these burgeouise antirealist "resonance hybrid" notions. 
- Armit and Robison popularised the term and "[aromatic sextet](https://doi.org/10.1039/CT9252701604)" with many persuasive molecular examples that different greatly from benzene but still maintain delocalised rings of six electrons. Ernesy Crocker, a scientist who never pursued the "Doctor" title, [got there first](https://doi.org/10.1021/ja01429a002) by applying the valence electron "octect rule" to all atoms in benzene with Lewis-Langmuir bonding and accounting for the aromatic stability from the remaining six electrons. He places the electrons clearly "outside" the ring due to charge considerations, but that the *"electrons are continually vibrating in the plane of the ring... The net physical effect... serving to bind together all carbon atoms present into virtually a single atom."*
...
- It is important to note that concept of hybridised orbitals played an outstanding role in having explanatory behaviour for typical organic bonding behaviour, and that argument on what should be considered "correct" representation of resonance hybrids (particularly of charged tautumers) since [dominant resonance contributors can be constructed from wavefunction based molecular orbitals](https://doi.org/10.3390/molecules26144110) by using natural bonding orbital analyses.   
