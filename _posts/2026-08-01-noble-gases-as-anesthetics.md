...
Butler was stating in **1950** *"If the inert gases can be considered true anesthetics, the action of these spherically symmetrical atoms without any permanent dipoles furnishes the most conclusive demonstration that anesthesia need not depend on the effect of any specific structural grouping."* I know this is obvious but how is this still ongoing?

1951 - Stuart Cullen and Edwin Gross [sucessful experiment on human patient](https://doi-org.wwwproxy1.library.unsw.edu.au/10.1126/science.113.2942.580)
...
And as we asked what a sphere can actually do the explainations get *stranger* not simpler

We've been using it since the 1940s. 
We haven't even had any structural data to argue over until 3--4 years ago!

- Just as we're getting dependable structural data, nuclear spin and interactions with radical pairs have been proposed to come in to play

[Radical pairs may play a role in xenon-induced general aneasthesia](https://doi-org.10.1038/s41598-021-85673-w)

This is an unsolved mystery so keep it a short one and keep it tight

Removing our *very consciousness* from supposedly *inert elements*. Suppressing what we cannot explain through chemical mechanisms we do not understand. But it just takes a huff!

Xe fractionally distilled from the tiny fraction in the air.

Xe not approved as an anaesthetic by the FDA, only used in EU.


On the [economics of Xenon use](https://doi.org/10.1111/anae.13569) https://associationofanaesthetists-publications.onlinelibrary.wiley.com/doi/10.1111/anae.13569



---

Nitrogen narcosis -- I believe this is how it was discovered??
...
[High-pressure crystallography shows noble gas intervention into protein-lipid interaction and suggests a model for anaesthetic action](https://www.nature.com/articles/s42003-022-03233-y)
- Target pentameric ligand-gated ion channels - Xen modulates n-methyl-aspartate, K+ channels GABA
- Kr and Ar need to be hyperbaric concentrations (7 and 27 bar!!)
- Study is on rhodopsins -- end of the the purple post
- Studies on crystals of bacteriorhodopsin, MAR proton-pump, nand KR2 sodium pump
- ESRF beamline, Kr 140 bar, Ar 2000 bar
- Only a small porion got the that cavities in constrast to prior studies
- Most atom positions are the in crystal contacts between molecules, artefacts of the xtalisation process
- All the Membrance Protein Kr/Ar positions can be reproduced by MD
- They posit it's the supression of membrane dynamics. Whether is this enough I dunno

[Nuclear Spin Attenuates the Anaesthetic Potency of Xenon Isotopes in Mice: Implications for the Mechanisms of Anaesthesia and Consciousness](https://rdcu.be/eYvJF) Potency of Xe-129 a& Xe-121 is less than spinless Xe-132 and Xe-134. What?? Coooll But what?
